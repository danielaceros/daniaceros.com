...
export const blogMemory: BlogMemoryEntry[] = [
  ...
  },
  {
    ...
    status: "published",
    notes: "Auto-generado por blog-auto (fallback evergreen — todos los 30 temas base cubiertos; tema extra generado fuera de lista, sin candidate SC limpio — token SC de Search Console sigue caducado, invalid_grant persistente desde hace semanas, requiere reautenticación manual). Imágenes Unsplash/Pexels.",
  },
  {
  ...
  },
  {
    ...
    status: "published",
    notes: "Auto-generado por blog-auto (fallback evergreen — los 30 temas base y varios extra ya cubiertos; tema nuevo elegido fuera de lista, sin candidate SC limpio — token SC sigue con invalid_grant persistente desde hace semanas, requiere reautenticación manual). Imágenes Unsplash.",
  },
  {
  ...
  },
  {
    ...
    status: "published",
    notes: "Auto-generado por blog-auto (fallback evergreen — los 30 temas base y numerosos extra ya cubiertos; tema nuevo elegido fuera de lista, sin candidate SC limpio — token SC de Search Console sigue caducado con invalid_grant persistente, requiere reautenticación manual). Imágenes Unsplash.",
  },
]
