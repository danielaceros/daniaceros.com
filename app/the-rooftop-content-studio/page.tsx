    ...
    <main className="min-h-screen bg-[#080808] text-white">
      <section className="mx-auto max-w-5xl px-4 pb-8 pt-6 sm:px-6 sm:pt-8 lg:px-8">
        <nav className="mb-10 rounded-full border border-white/10 bg-black/65 px-5 py-3 backdrop-blur">
          <ul className="flex flex-wrap items-center gap-x-5 gap-y-2 text-[10px] uppercase tracking-[0.08em] text-white/70 sm:text-[11px]">
        ...
        <p className="text-[11px] uppercase tracking-[0.16em] text-white/60 sm:text-[12px]">
      ...
      <section className="mx-auto max-w-5xl overflow-hidden border-y border-white/10 py-3">
        <div className="rooftop-ticker whitespace-nowrap text-[10px] uppercase tracking-[0.12em] text-white/55 sm:text-[11px]">
      ...
      <section className="mx-auto grid max-w-5xl gap-8 px-4 py-14 sm:px-6 lg:grid-cols-2 lg:px-8">
        <div>
          <p className="text-[12px] uppercase tracking-[0.16em] text-white/55">( Que es )</p>
          ...
          <h3 className="mt-7 text-[13px] font-semibold uppercase tracking-[0.08em] text-white/88">
      ...
      <section className="mx-auto max-w-5xl px-4 pb-14 sm:px-6 lg:px-8">
        <p className="mb-4 text-[12px] uppercase tracking-[0.16em] text-white/55">( Galeria )</p>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-14 sm:px-6 lg:px-8">
        <p className="mb-4 text-[12px] uppercase tracking-[0.16em] text-white/55">( Beneficios )</p>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-14 sm:px-6 lg:px-8">
        <p className="mb-4 text-[12px] uppercase tracking-[0.16em] text-white/55">( Proceso )</p>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-14 sm:px-6 lg:px-8">
        <p className="mb-4 text-[12px] uppercase tracking-[0.16em] text-white/55">( Tarifas )</p>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <article className="rounded-2xl border border-white/10 bg-white/[0.02] p-6">
            <p className="text-[11px] uppercase tracking-[0.12em] text-white/55">Media Jornada</p>
            ...
            <button className="mt-6 rounded-full border border-white/20 px-5 py-2 text-[12px] uppercase tracking-[0.08em] text-white/90">
              Reservar
            </button>
          </article>

          <article className="rounded-2xl border border-white/20 bg-white/[0.05] p-6">
            <p className="inline-block rounded-full border border-white/25 px-3 py-1 text-[10px] uppercase tracking-[0.1em] text-white/80">
              Popular
            </p>
            <p className="mt-4 text-[11px] uppercase tracking-[0.12em] text-white/55">Jornada Completa</p>
            ...
            <button className="mt-6 rounded-full border border-white/30 bg-white/10 px-5 py-2 text-[12px] uppercase tracking-[0.08em] text-white">
              Reservar
            </button>
          </article>
        </div>

        <p className="mt-5 text-[12px] uppercase tracking-[0.1em] text-white/55">
          Incluye: Espacio · Filmmaker · Equipo tecnico
        </p>
      </section>

      <section className="mx-auto max-w-5xl px-4 pb-14 sm:px-6 lg:px-8">
        <p className="mb-4 text-[12px] uppercase tracking-[0.16em] text-white/55">( Ubicacion )</p>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-14 sm:px-6 lg:px-8">
        <p className="mb-4 text-[12px] uppercase tracking-[0.16em] text-white/55">( FAQ )</p>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-16 sm:px-6 lg:px-8">
        <p className="mb-4 text-[12px] uppercase tracking-[0.16em] text-white/55">( Contacto )</p>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <form className="grid gap-3 rounded-2xl border border-white/10 bg-black/35 p-5">
            ...
            <button className="mt-2 rounded-full border border-white/25 px-5 py-2 text-[12px] uppercase tracking-[0.08em] text-white/90">
              Enviar
            </button>
          </form>
        </div>
      ...
      <footer className="border-t border-white/10">
        <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
          <p className="text-[11px] uppercase tracking-[0.1em] text-white/55">Navegacion</p>
